...
- **Gebinde statt Mengen:** In der Einkaufsliste steht bei jedem Artikel, wie viele Packungen du kaufen musst (z. B. „2× Packung“), statt der rohen Mengen aus den Rezepten. Das wird aus der benötigten Menge und der Packungsgröße des Angebots berechnet und immer aufgerundet. Passen die Einheiten nicht zusammen (z. B. Rezept in „Stück“, Angebot in Gramm) oder lässt sich eine Menge nicht auswerten, wird die Anzahl der Verwendungen als vorsichtige Mindestmenge angenommen.
- **Angebote-Reiter:** Dritter Reiter neben Wochenplan und Einkaufsliste, listet alle gefundenen Angebote der gewählten Märkte auf, nicht nur die im Plan verwendeten. Wird beim ersten Öffnen des Reiters geladen und für die aktuelle Auswahl (Postleitzahl, Märkte, Abneigungen) im Browser zwischengespeichert.
- **Teilen-Knöpfe:** Alle drei Reiter haben einen Teilen-Knopf („Plan teilen“, „Liste teilen“, „Angebote teilen“), der den jeweiligen Inhalt als Text über das Teilen-Menü des Handys verschickt, z. B. an WhatsApp, Notizen oder E-Mail. In der Einkaufsliste werden bereits abgehakte Artikel weggelassen. Ohne Teilen-Funktion landet der Text in der Zwischenablage, als letzter Rückfall in einem Textfeld zum manuellen Kopieren. Eine direkte Übergabe an die Alexa-Einkaufsliste ist nicht möglich – Amazon hat die dafür nötige Schnittstelle für Drittanbieter am 1. Juli 2024 abgeschaltet.
